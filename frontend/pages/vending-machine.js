...
const VendingMachine = () => {
    ...
    const restockDonutHandler= async() =>{
        try {
            await vmContract.methods.restock(buyCount).send({
                from: address
            })
            setSuccessMsg(`${buyCount} donuts restocked!`)
    ...
    return (
        <div className={styles.main}>
            <Head>
                ...
                <meta name="description" content="A bloackchain vending machine app" />
            </Head>
            ...
            <section className="mt-5">
                <div className="container">
                    <div className="field">
                        <label className="label">Restock donuts</label>
                        <div className="control">
                            <input onChange={updateDonutQty} className="input" type="type" placeholder="Enter amount..." />
                        </div>
                        <button
